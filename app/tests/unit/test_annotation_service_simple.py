...
class TestAnnotationServiceSimple:
    """Simplified test cases for AnnotationService."""
    ...
    def annotation_service(self):
        ...
        service.room_registry = MagicMock()
    ...
    @pytest.mark.asyncio
    async def test_create_rectangle_annotation(self, annotation_service):
    ...
    @pytest.mark.asyncio
    async def test_create_ellipse_annotation(self, annotation_service):
    ...
    @pytest.mark.asyncio
    async def test_create_polygon_annotation(self, annotation_service):
    ...
    @pytest.mark.asyncio
    async def test_create_freehand_annotation(self, annotation_service):
    ...
    async def test_update_annotation(self, annotation_service):
        ...
        from app.schemas.annotation import AnnotationUpdateRequest
        ...
        assert seq == 1
        annotation_service.room_registry.append_update.assert_called()
